% Jelen dokumentum NEM tekinthető az SZTE Informatikai Tanszékcsoport
% hivatalos dokumentumának. Ellenben azon alapszik.
% Utolsó érdembeli módosítás: 2018.01.23.
% Az alábbiakat figyelembevéve szabadon felhasználható.
% Örökült licenc:
...
%%% A fájl használatához szükséges a magyar.ldf 2005/05/12 v1.5-ös vagy későbbi
%%% verziója; ez letölthető a http://www.math.bme.hu/latex/ weblapról,
%%% a magyar nyelvű szedéshez hasznos információk, linekek, LaTeX leírások
%%% a www.latex.lap.hu weboldalon vannak.
...
%%%
% A 1.5-es sortöréshez kell.
\usepackage{setspace}

%%%
% Hasznos csomag, mely linkeli a PDF-et. PDF-ben kattintásra ugrik
% a referenciához.
\usepackage[pdfusetitle]{hyperref}

%%% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% Állítsuk be a dolgozat címét!
\title{<Szakdolgozat \LaTeX\ minta>}

%%% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% Valamint adjuk meg a PDF készítőjét
% (Ez nem azonos a „Hallgató neve” résszel, ez csak a PDF meta-adata lesz.)
\author{Szilárd Ledán}

%%%
% A PDF-ben megjelenő linkek színei és a dokumentum nyelve (meta-adat).
\hypersetup{
    colorlinks,
    citecolor=black,
    filecolor=black,
...
%%%
% Irodalomjegyzék készítéséhez.
% A helyes használathoz a „bib” mappában lévő „cites.bib” fájlt kell
% szerkeszteni. További infó: http://www.bibtex.org/
\usepackage{cite}

%%%
% Számozott felsorolásokhoz
\usepackage{enumerate}
%\usepackage{enumitem}

%%%
% Saját színek definiálása.
\usepackage{color}
\definecolor{myCommentColorGreen}{RGB}{0,128,0}
\definecolor{myLineNumberGray}{RGB}{128,128,128}

%%%
% Forráskód beillesztéséhez. (Ezzel el lehet szórakozni...)
\usepackage{listings}
\lstset{ %
...
%%%
% Csak a „Mottó"-hoz használtuk.
%   FIGYELEM: A formai követelmény nem tartalmazz mottó oldalt.
%             Ezt csak a jelen séma szerzője adta hozzá. A dolgozat
%             összoldalszámába nem szabad beleszámolni.
\usepackage{epigraph}
%\epigraphfontsize{\small\itshape}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Saját definíciók és parancsok                                  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%
% Tételszerű környezetek definiálhatók, ezek most fejezetenként együtt
% számozódnak, pl.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Dokumentum nyomdai beállításai                                 %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % A tartalomjegyzékben mégis szerepeltetni kell, mint szakasz(section)
    % szerepeljen:
...
% A tartalmi összefoglalónak tartalmaznia kell (rövid, legfeljebb egy oldalas,
% összefüggő megfogalmazásban) a következőket: a téma megnevezése, a megadott
% feladat megfogalmazása - a feladatkiíráshoz viszonyítva-, a megoldási mód, az
% alkalmazott eszközök, módszerek, az elért eredmények, kulcsszavak (4-6
% darab).

% Az összefoglaló nyelvének meg kell egyeznie a dolgozat nyelvével. Ha a
% dolgozat idegen nyelven készül, magyar nyelvű tartalmi összefoglaló készítése
% is kötelező (külön lapon), melynek terjedelmét a TVSZ szabályozza.
